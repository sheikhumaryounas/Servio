...
export const sendRegistrationOtpEmail = async (toEmail, otp) => {
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px; background-color: #fdfdfd;">
        ...
        <div style="border-top: 1px solid #eeeeee; padding-top: 20px;">
          <p style="font-size: 14px; color: #333333; line-height: 1.5;">Hello,</p>
          <p style="font-size: 14px; color: #333333; line-height: 1.5;">Thank you for registering with Servio! Please use the following 6-digit OTP code to verify your account and complete registration:</p>
  ...
  try {
    ...
    if (usingEthereal) {
      previewUrl = nodemailer.getTestMessageUrl(info);
      console.log('\n==================================================');
      console.log('📧  [emailService] Ethereal signup email sent successfully!');
      console.log(`🔗  Preview URL: ${previewUrl}`);
      console.log(`🔑  OTP Code: ${otp}`);
      console.log('==================================================\n');
    } else {
      console.log(`[emailService] Signup email sent successfully to ${toEmail}. Message ID: ${info.messageId}`);
    }
    ...
    console.log(`Reason: ${error.message}`);
    console.log('--------------------------------------------------');
    console.log(`🔑  DEVELOPMENT SIGNUP OTP CODE FOR TESTING: ${otp}`);
    console.log('==================================================\n');
